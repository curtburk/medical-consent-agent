...
# DON'T import monitor here - imports torch and triggers CUDA init
...
class ConsentAgentV2:
    ...
    def __init__(self, enable_tts: bool = True, enable_translation: bool = True):
        ...
        # Skip STT - causes CUDA init before vLLM
        print("   Skipping STT (text-only mode for Week 2)")
        self.stt = None
        ...
        # NOW import monitor (after vLLM initialized CUDA)
        from utils.monitor import print_stats, check_resource_health
        self.print_stats = print_stats
        self.check_resource_health = check_resource_health
        ...
        self.print_stats(show_title=False)
    ...
    def process_text(
        ...
        if self.enable_translation and self.translator and language != 'en':
    ...
    def set_session_metadata(self, language: str = None, procedure: str = None, patient_id: str = None):
...
def interactive_mode_v2():
    ...
    agent = ConsentAgentV2(
        enable_tts=False,  # Start with TTS off for faster testing
